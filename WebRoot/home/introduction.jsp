...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	GoodInfo goodinfo=(GoodInfo)session.getAttribute("goodinfo");
	 %>
	<head>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="../images/01.jpg"><img src="../images/01_mid.jpg" alt="细节展示放大镜特效" rel="<%good.getgImg(); %>" class="jqzoom" /></a>
							</div>
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>价格</dt>
									<dd><em>¥</em><b class="sys_item_price"><%good.getgPrice(); %></b>  </dd>                                 
								</li>
								<div class="clear"></div>
							</div>
								...
								<div class="iteminfo_freprice">
									<div class="am-form-content address">
										<select data-am-selected>
											<option value="a"><%user.getAddress(); %></option>
										</select>
									<div class="pay-logis">
						...
						<div id="prof" class="item">
							...
							<div class="ibar_login_box status_login">
								<div class="avatar_box">
									...
									<ul class="user_info">
										<li>用户名：<%if(user!=null){user.getUsername();} %>></li>
										<li>级&nbsp;别：普通会员</li>
									</ul>
								</div>
